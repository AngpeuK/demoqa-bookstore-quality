...
| REQ-SEC-01 Secrets are not committed                     | Supply chain  | Gitleaks          | Security Gate            | Covered                 |
| REQ-SEC-02 High/Critical dependencies block delivery     | Supply chain  | pnpm audit/review | Security Gate            | Covered                 |
| REQ-SEC-03 TypeScript receives security-extended SAST    | Code security | CodeQL            | Security Gate            | Covered                 |
| REQ-SEC-04 Release composition is traceable              | Supply chain  | SPDX SBOM         | Security Gate            | Covered                 |
| REQ-SEC-05 HTTP/API defensive contracts remain explicit  | AppSec        | SEC-001..007      | Playwright API           | Partial / known defects |
